...
int main(int argc, char* argv[]) {
  // bin/exec images/image1.ppm -h 1 -o carved.ppm
  // image1:/home/vagrant/src/mp-seam-carving-ahafi2/images/image1.ppm
  ...
  // std::cout << carver.GetImage().ToString() << std::endl;
